...
CDevice::CDevice()
{
    m_endpoint = nullptr;
    m_endpoint_id = 0;
    m_measured_value_illuminance = 0;
    m_measured_value_illuminance_prev = 0;
}
...
void CDevice::update_measured_value_illuminance(uint16_t value)
{
    m_measured_value_illuminance = value;
}
